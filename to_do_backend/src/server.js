...
const PORT = parseInt(process.env.REACT_APP_PORT, 10) || 4000;
const TRUST_PROXY =
  (process.env.REACT_APP_TRUST_PROXY || "").toString().toLowerCase() === "true" ||
  (process.env.REACT_APP_TRUST_PROXY || "").toString() === "1";
const LOG_LEVEL = process.env.REACT_APP_LOG_LEVEL || "dev";
const HEALTH_PATH = process.env.REACT_APP_HEALTHCHECK_PATH || "/healthz";
const FRONTEND_ORIGIN = process.env.REACT_APP_FRONTEND_URL || "http://localhost:3000";
